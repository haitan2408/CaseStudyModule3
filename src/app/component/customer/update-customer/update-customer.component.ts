...
export class UpdateCustomerComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,private customerService: CustomerService, private fb: FormBuilder, private router: Router, public snackbar: MatSnackBar) { }
  ...
  ngOnInit() {
    ...
    this.customerService.getCustomer(this.id).subscribe(res => {
      ...
      this.registerForm.patchValue(this.customerInfo);
    })
  }
  ...
  onSubmitRegisters() {
    ...
    if (this.registerForm.valid) {
      this.customerService.updateCustomer(this.id,this.registerForm.value).subscribe(data => {
